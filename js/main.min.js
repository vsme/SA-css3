...
function previousAnimalProcess(t) {
...
function animationstatequestion(t) {
    ...
    animalanimationstimeoutnext = setTimeout(function () {
        a == animalanimationstate && $("body").addClass("animal-animations-on")
    }, 2e3)
}
...
function startslideshow() {
    $("body").addClass("slideshow-on"), $(".main-nav li:nth-child(2) a").addClass("stop"), $(".main-nav li:nth-child(2) .popout").addClass("text-change"), setTimeout(function () {
        $(".main-nav li:nth-child(2) .popout").removeClass("text-change"), $(".main-nav li:nth-child(2) .popout").text("停止播放")
...
function turnoffslideshow() {
    slideshowvar += 1, $(".main-nav li:nth-child(2) a").removeClass("stop"), $(".main-nav li:nth-child(2) .popout").addClass("text-change"), setTimeout(function () {
        $(".main-nav li:nth-child(2) .popout").removeClass("text-change"), $(".main-nav li:nth-child(2) .popout").text("自动播放")
...
$(document).ready(function () {
    sizeshards(), detectBrowser(), SOUNDS.init(), setTimeout(function () {
        ...
        $(".main-nav li:nth-child(3).muted").length ? (soundManager.unmute(), $(this).removeClass("muted"), $(".main-nav li:nth-child(3) .popout").addClass("text-change"), setTimeout(function () {
            $(".main-nav li:nth-child(3) .popout").removeClass("text-change"), $(".main-nav li:nth-child(3) .popout").text("关闭声音")
        }, 150)) : (soundManager.mute(), $(this).addClass("muted"), $(this).setAttribute('onclick', 'p();return false;'), $(".main-nav li:nth-child(3) .popout").addClass("text-change"), setTimeout(function () {
            $(".main-nav li:nth-child(3) .popout").removeClass("text-change"), $(".main-nav li:nth-child(3) .popout").text("打开声音")
        }, 150))
    }), $("footer .about").on("click", function (t) {
        overlayContent = ".overlay .about", overlayprocess()
    }), $("footer .how").on("click", function (t) {
        overlayContent = ".overlay .how", overlayprocess()
    }), $("footer .sources").on("click", function (t) {
        overlayContent = ".overlay .sources", overlayprocess()
    }), $("footer .share").on("click", function (t) {
        overlayContent = ".overlay .sharing-goodies", overlayprocess()
    }), $("footer .footer-nav").on("click", function (t) {
        $("footer").toggleClass("mobile-footer-active")
    }), $(".animalinfo .wallpaper").on("click", function (t) {
        overlayContent = ".overlay .download";
        var a = "下载 " + animalNames[newAnimal] + " 图形到桌面作为壁纸。";
        $(".overlay .download h2").text(a);
        var e = "img/assets/wallpapers/2560x1600/2560x1600_" + animalList[newAnimal] + ".png", n = "img/assets/wallpapers/1920x1080/1920x1080_" + animalList[newAnimal] + ".png", i = "img/assets/wallpapers/all-animals/all-animals_2560x1600.png", o = "img/assets/wallpapers/1024x1024/1024x1024_" + animalList[newAnimal] + ".png";
        $(".overlay .download img").attr("src", i), $(".overlay .download li:nth-child(1) a").attr("href", e), $(".overlay .download li:nth-child(2) a").attr("href", n), $(".overlay .download li:nth-child(3) a").attr("href", i), $(".overlay .download li:nth-child(4) a").attr("href", o), overlayprocess()
    }), $(".overlay .close").on("click", function (t) {
        animationstatequestion(), $(".overlay").toggleClass("active"), setTimeout(function () {
            $(".overlay div").removeClass("active")
        }, 500)
    }), $(".hover-detector div").on("mouseover", function (t) {
        $(".shard-wrap .shard").not(this).removeClass("active"), $(".level-one").addClass("shadow-active");
        var a = $(this).index() + 1;
        $(".shard-wrap:nth-child(" + a + ") .shard").addClass("active"), $(".animal-nav-content ul li:nth-child(" + a + ")").addClass("active"), $(".animal-nav-content .title-content").addClass("inactive");
        var e = $(this).attr("data-animalClick");
        $(".animal-nav-content").attr("animal", e), $(".animal-nav-content div").each(function () {
            $(this).hasClass(e) ? $(this).addClass("active") : $(this).removeClass("active")
        })
    ...
    }), $(".statistics .stats-ui li:nth-child(2) .line-link").on("click", function (t) {
        currentChartNumber = 1, activeChartLinks($(this))
    }), $(".statistics .stats-ui li:nth-child(3) .line-link").on("click", function (t) {
    ...
    }), $(".random-animal-btn").on("click", function (t) {
        turnoffanimalnav(), randomAnimal()
    }), $(".chromebrowser .nav-btn, .chromebrowser .why-endangered, .chromebrowser .box-link").on("mouseenter", function (t) {
        SOUNDS.play("hover")
    }), $(".chromebrowser .hover-detector div, .chromebrowser .line-link, .chromebrowser .ctas a, .chromebrowser .animalinfo a").on("mouseenter", function (t) {
    ...
    }), $(".browser-statement .close").on("click", function (t) {
        $(".browser-statement").addClass("inactive")
    }), $(".nowebkitbrowser .next a, .nowebkitbrowser .prev a").on("click", function (t) {
    ...
    if ($(".touch").length); else if ($(".preloader-layer-2").length || $(".all-animals").length) {
        ...
        console.log("public variable:" + resizingPublicVariable + " variable: " + t), setTimeout(function () {
            console.log("public variable:" + resizingPublicVariable + " variable: " + t), t == resizingPublicVariable && $(".resize-hider").removeClass("active")
        }, 240)
    }
    sizeshards()
